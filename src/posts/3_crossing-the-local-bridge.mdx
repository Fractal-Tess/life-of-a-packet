...
<SingleQuestion
  client:load
  label="Which OSI layer do MAC addresses operate at?"
  choices={[
    'Physical Layer',
    'Data Link Layer',
    'Network Layer',
  ...
  correct={1}
  explanation="MAC addresses operate at the Data Link Layer (Layer 2) of the OSI model, handling local network delivery."
/>
...
<SingleQuestion
  client:load
  label="What does ARP stand for in networking?"
  choices={[

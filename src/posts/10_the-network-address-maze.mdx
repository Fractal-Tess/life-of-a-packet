...
<SingleQuestion
  ...
  correct={1}
  explanation="IPv6 was developed to provide more IP addresses."
/>
<Spliter />
...
<MultipleQuestion
  label="Which of the following are true about IPv6?"
  choices={[
    '128-bit addresses',
    'Hexadecimal notation',
    'Built-in security features',
    'Same address space as IPv4',
  ]}
  correct={[0, 1, 2]}
  explanation="IPv6 uses 128-bit addresses, hexadecimal notation, and has built-in security features. It does not have the same address space as IPv4."
/>
...
<OpenQuestion
  label="What does CIDR stand for in networking? (Type the full phrase)"

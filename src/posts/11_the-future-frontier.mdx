...
<SingleQuestion
  ...
  correct={1}
  explanation="SDN's primary benefit is centralized network control and programmability."
/>
<Spliter />
...
<MultipleQuestion
  label="Which of the following are benefits of Network Function Virtualization (NFV)?"
  choices={[
  ...
  correct={[0, 1, 2]}
  explanation="NFV virtualizes network functions, runs on standard servers, and increases flexibility and scalability. It does not require specialized hardware."
/>
...
<OpenQuestion
  label="What is network slicing in 5G? (Short answer)"
  correct="Creating virtual networks for different use cases"

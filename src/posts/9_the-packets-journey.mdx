...
<SingleQuestion
  ...
  correct={1}
  explanation="Global routing finds the best path between networks worldwide."
/>
<Spliter />
...
<MultipleQuestion
  label="Which of the following are true about BGP?"
  choices={[
    'It is used for routing between Autonomous Systems',
    'It is a type of firewall',
    'It is the main protocol for global routing',
    'It manages wireless connections',
  ]}
  correct={[0, 2]}
  explanation="BGP is used for routing between Autonomous Systems and is the main protocol for global routing."
/>
...
<OpenQuestion
  label="What does TTL stand for in networking? (Short answer)"
